...
public class MealPlanningServiceTests
{
    ...
    public async Task Given_NonExistentRecipes_When_UpdatingMealPlan_Then_ShouldThrowException()
    {
      ...
      (
        ...
        {
            new Recipe("Recipe1", "Description", "short", new List<Ingredient>(), null, "path/to/image", null)
        };

        var nonExistentRecipes = new List<Recipe>()

        {
            new Recipe("NonExistentRecipe1", "Description", "short", new List<Ingredient>(), null, "path/to/image", null)
