# shopping-list-management Specification

## Purpose

Defines explicit shopping-list generation, aggregation, household checklist state, manual items, safe regeneration, and plain-text export.
