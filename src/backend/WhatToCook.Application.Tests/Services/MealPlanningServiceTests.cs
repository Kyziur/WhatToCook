...
public class MealPlanningServiceTests
{
    ...
    public async Task Given_InvalidDateRange_When_UpdatingMealPlan_Then_ShouldThrowException()
    {
        ...
        {
        new RecipePerDay(recipeDate1, new Recipe("OldRecipe1", "Description1", "short", new List<Ingredient>(), new Image("path/to/image1"))),
        new RecipePerDay(recipeDate2, new Recipe("OldRecipe2", "Description2", "medium", new List<Ingredient>(), new Image("path/to/image1")))
        };
        ...
        {
        new Recipe("Recipe1", "Description1", "short", new List<Ingredient>(), new Image("path/to/image1")),
        new Recipe("Recipe2", "Description2", "medium", new List<Ingredient>(), new Image("path/to/image1"))
        };
    ...
    public async Task Given_ValidData_When_CreatingMealPlan_Then_Succeeds()
    {
        ...
        var recipes = new List<Recipe>()
        {
            new Recipe("Recipe1", "Description1", "short", new List<Ingredient>(), new Image("path/to/image1")),
            new Recipe("Recipe2", "Description2", "medium", new List<Ingredient>(), new Image("path/to/image1")),
            new Recipe("Recipe3", "Description2", "medium", new List<Ingredient>(), new Image("path/to/image1"))
        };
        var planOfMealsForDayList = daysInRange.Select(day => new PlanOfMealForDay
        {
            Day = day,
